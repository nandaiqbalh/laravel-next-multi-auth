...
export default async function HomePage() {
  ...
  return (
    <main className="min-h-screen">
        ...
        <div className="flex h-14 w-full items-center justify-between px-4 sm:px-8 lg:px-10">
          ...
          <div className="flex items-center gap-2">
            {session ? (
              ...
              <>
                <Link href="/login" className="px-3 py-1.5 text-sm font-medium text-gray-600 hover:text-green-800">
                  Masuk
                </Link>
                <Link
                  href="/register"
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-green-800 via-green-700 to-emerald-700 px-4 py-20 text-white sm:px-6 sm:py-28">
        <div className="absolute -left-20 -top-20 h-72 w-72 rounded-full bg-white/10 blur-3xl" />
        <div className="absolute -bottom-20 right-0 h-80 w-80 rounded-full bg-emerald-300/10 blur-3xl" />
        ...
        <div className="relative w-full px-2 text-center sm:px-6">
          ...
          <p className="mt-5 text-base text-green-100 sm:text-lg">
          ...
          <div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row">
            <Link
              ...
              className="rounded-xl bg-white px-7 py-3 text-sm font-bold !text-green-900 hover:bg-green-50 sm:text-base"
            >
          ...
          <div className="mt-10 grid grid-cols-1 gap-3 text-left sm:grid-cols-3">
            <div className="rounded-xl border border-white/20 bg-white/10 p-4">
              ...
              <p className="mt-1 text-xs text-green-100">Admin dan user dengan akses terpisah.</p>
            </div>
            <div className="rounded-xl border border-white/20 bg-white/10 p-4">
              <p className="text-sm font-semibold">CRUD Foundation</p>
              <p className="mt-1 text-xs text-green-100">Users, roles, modal form, search, dan pagination.</p>
            </div>
            <div className="rounded-xl border border-white/20 bg-white/10 p-4">
              <p className="text-sm font-semibold">API Production Pattern</p>
              <p className="mt-1 text-xs text-green-100">Arsitektur repository-service-action yang rapi.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="px-4 pb-12 sm:px-8 lg:px-10">
        <div className="card bg-gradient-to-r from-green-50 via-white to-emerald-50 p-6 sm:p-8">
