...
export const metadata = {
  title: 'Daftar Pengajuan UMKM',
  description: 'Kelola status pengajuan layanan UMKM.',
};


/**
 * Admin UMKM submission list page separated into a dedicated client page.
 */
export default async function AdminPengajuanPage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader title="Daftar Pengajuan" description="Kelola status pengajuan layanan UMKM." />
