...
export const metadata = {
  title: 'Rekap Pengajuan Layanan',
  description: 'Lihat rekapitulasi status pengajuan layanan.',
};

/**
 * Rekap page for admin.
 */
export default async function AdminRekapPage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader title="Rekap Layanan" description="Rekap profil, claim, dan pengajuan layanan." />
